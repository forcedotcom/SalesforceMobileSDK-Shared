...
define("salesforce/util/logger", function(require, exports, module) {
    var logger = {
        appStartTime: (new Date()).getTime(),  // Used for debug timing measurements.
...
/**
 * Utilify functions for creating various URLs (e.g. app URL, local app URL etc)
 */
define("salesforce/util/urlbuilder", function(require, exports, module) {
...
/**
 * Utility functions used at startup (e.g. localUrl, deviceIsOnline)
 */
